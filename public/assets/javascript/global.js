...
var gather = function() {
  ...
  .fail(function() {
    console.log("Sorry. Server unavailable. -gather");
  });
};
...
var saveNote = function() {
  ...
  $("#note-button").on('click', function() {
    ...
    .fail(function() {
      console.log("Sorry. Server unavailable. -save");
    });
...
var deleteNote = function() {
  ...
  $("#delete-button").on('click', function() {
    ...
    .fail(function() {
      console.log("Sorry. Server unavailable. -delete");
    });
...
var fetchData = function() {
  ...
  $.ajax({
    ...
    alert("Sorry. Server unavailable. -scrape");
  });
};
